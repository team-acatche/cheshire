            ...
            <div className="flex items-center justify-between rounded-lg border border-destructive/30 bg-destructive/5 px-4 py-3">
              ...
              {confirm === "sessions" ? (
                <div className="flex shrink-0 items-center gap-2">
                  ...
                  <Button size="xs" variant="destructive" onClick={() => setConfirm(null)}>Yes, delete</Button>
                  <Button size="xs" variant="outline" onClick={() => setConfirm(null)}>Cancel</Button>
                </div>
              ) : (
                <Button size="sm" variant="destructive" onClick={() => setConfirm("sessions")}>
                  Delete
                </Button>
              )}
            </div>
    ...
    >
      ...
      >
        ...
        <div className="flex w-[200px] shrink-0 flex-col border-r border-border bg-muted/20 px-2 py-4">
          {/* Close button — top-left, matching the mockup */}
          <button
            type="button"
            onClick={onClose}
