...
from haystack.components.generators.chat.llm import ChatGenerator
...
class DocumentPreprocessor(Protocol):
    def __call__(self, document: Path, store: DocumentStore) -> None:
        ...
...
class PipelineConfig:
    ...
    system_prompt: str = """
		...
		Repeat steps 1-3 until you are certain you have analyzed the entire system specification.
